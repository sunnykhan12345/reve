        ...
        <MotionSection>
          <div className="grid items-start gap-10 lg:grid-cols-[360px_1fr] lg:gap-[72px]">
            ...
            <div className="flex h-full flex-col justify-between pt-1 lg:pt-9">
              ...
              <div className="mt-10 flex items-center justify-center gap-4 lg:mt-[66px]">
                <button
                  type="button"
        ...
        <div className="mt-16 overflow-hidden">
          ...
          >
            {serviceCards.map((service, index) => (
              ...
              >
                <Card className="group flex h-full min-h-[325px] w-full flex-col rounded-[16px] border-0 bg-[#F6F6F6] p-5">
